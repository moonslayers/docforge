# 👋 ¡Hola! Soy tu asistente de documentación

Bienvenido a la documentación de **test1**.
...
├── AGENTS.md         ← Este archivo (instrucciones para ti)
